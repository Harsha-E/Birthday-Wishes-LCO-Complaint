    ...
    var b = function () {
                    ...
                    if (0 !== a.length) {
                        ...
                        c <= 2
                            ? this
                                .$results
                                .scrollTop(0)
                            : (g > this.$results.outerHeight() || g < 0) && this
                                .$results
                                .scrollTop(f)
                    }
                },
            ...
            b.define("select2/selection/search", [
                ...
                return d.prototype.render = function (b) {
                    var c = a(
                        ...
                        'capitalize="none" spellcheck="false" role="textbox" aria-autocomplete="list" /' +
                        '></li>'
                    );
                ...
                return c.prototype.render = function (b) {
                    var c = b.call(this),
                        d = a(
                            ...
                            'autocapitalize="none" spellcheck="false" role="textbox" /></span>'
                        );
            ...
            b.define("select2/compat/initSelection", ["jquery"], function (a) {
                function b(a, b, c) {
                    c.get("debug") && window.console && console.warn && console.warn(
                        "Select2: The `initSelection` option has been deprecated in favor of a custom d" +
                        "ata adapter that overrides the `current` method. This method is now called mul" +
                        "tiple times instead of a single time when the instance is initialized. Support" +
                        " will be removed for the `initSelection` option in future versions of Select2"
                    ),
                ...
                return b.prototype.current = function (b, c) {
                    ...
                    this
                        .initSelection
                        .call(null, this.$element, function (b) {
                            d._isInitialized = !0,
                            a.isArray(b) || (b = [b]),
                            c(b)
                        })
            ...
            b.define("select2/compat/inputData", ["jquery"], function (a) {
                function b(a, b, c) {
                    ...
                    "hidden" === b.prop("type") && c.get("debug") && console && console.warn && console.warn(
                        "Select2: Using a hidden input with Select2 is no longer supported and may stop" +
                        " working in the future. It is recommended to use a `<select>` element instead."
                    ),
                    a.call(this, b, c)
                }
                return b.prototype.current = function (b, c) {
                    function d(b, c) {
                        var e = [];
                        return b.selected || -1 !== a.inArray(b.id, c)
                            ? (b.selected = !0, e.push(b))
                            : b.selected = !1,
                        b.children && e
                            .push
                            .apply(e, d(b.children, c)),
                        e
                    }
                    for (var e = [], f = 0; f < this._currentData.length; f++) {
                        ...
                        e
                            .push
                            .apply(e, d(g, this.$element.val().split(this._valueSeparator)))
                    }
                    c(e)
                },
            ...
            b.define("select2/compat/query", [], function () {
                function a(a, b, c) {
                    c.get("debug") && window.console && console.warn && console.warn(
                        "Select2: The `query` option has been deprecated in favor of a custom data adap" +
                        "ter that overrides the `query` method. Support will be removed for the `query`" +
                        " option in future versions of Select2."
                    ),
                    a.call(this, b, c)
                }
                return a.prototype.query = function (a, b, c) {
            ...
            function (c) {
                ...
                if (a.event.fixHooks) 
                    for (var j = g.length; j;) 
                        a
                            .event
                            .fixHooks[g[--j]] = a.event.mouseHooks;
